...
export default function FormPromociones({onClose}: Props){
  const { Empresa, tipoDocumento, Promociones, cargo, modalidadTrabajo, especificidadCargo, NivelCargo, CentroCostos, CentroOperativo, UnidadNegocio, TipoContrato, TipoVacante, 
    DeptosYMunicipios, PasosPromocion, DetallesPasosPromocion, ColaboradoresDH, ColaboradoresEDM} = useGraphServices();
  ...
  const selectedTipoContrato = tipoContratoOptions.find((o) => o.label === state.TipoContrato) ?? null;
        ...
        <form className="ft-form" noValidate>
          ...
          <div className="ft-field">
            ...
            <Select<desplegablesOption, false>
              ...
              onChange={(opt) => {setField("TipoContrato", opt?.label ?? "");}}
              classNamePrefix="rs"
              ...
              isClearable
            />
            <small>{errors.TipoContrato}</small>
          </div>
