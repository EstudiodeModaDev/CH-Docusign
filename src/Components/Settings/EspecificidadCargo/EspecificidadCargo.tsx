...
export const EspecificidadManager: React.FC = () => {
    const { cargo, } = useGraphServices();
    const { items, add, editItem, reload, remove} = useCargo(cargo);
                    ...
                    <>
                        <section className="emp-form">
                            <div className="emp-field">
                                ...
                                <input id="empresaNombre" type="text" className="emp-input" placeholder="Especificidad de cargo" value={state?.Title} onChange={(e) => setState({...state, Title: e.target.value})}/>
                            </div>
                            { isEditing &&
