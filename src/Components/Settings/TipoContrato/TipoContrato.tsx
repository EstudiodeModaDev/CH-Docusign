...
export const TipoContratoManager: React.FC = () => {
    const { TipoContrato, } = useGraphServices();
    const { items, add, editItem, reload, remove} = useTipoContrato(TipoContrato);
                    ...
                    <>
                        <section className="emp-form">
                            <div className="emp-field">
                                ...
                                <input id="empresaNombre" type="text" className="emp-input" placeholder="Tipo de contrato" value={state?.Title} onChange={(e) => setState({...state, Title: e.target.value})}/>
                            </div>
                            { isEditing &&
