                    ...
                    <>
                        <section className="emp-form">
                            <div className="emp-field">
                                ...
                                <input id="empresaNombre" type="text" className="emp-input" placeholder="Tipo de vacante" value={state?.T_x00ed_tulo1} onChange={(e) => setState({...state, T_x00ed_tulo1: e.target.value.toUpperCase()})}/>
                            </div>
                            { isEditing &&
