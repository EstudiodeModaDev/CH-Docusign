...
export class DeptosYMunicipiosService {
  ...
  // ---------- CRUD ----------
  async create(record: Omit<dobleCampo, 'ID'>) {
  ...
  async update(id: string, changed: Partial<Omit<dobleCampo, 'ID'>>) {
    await this.ensureIds();
