...
export class RetailService {
  ...
  constructor(
    ...
    listName = 'Retail - Novedades Retail'
  ) {
    this.graph = graph;
  ...
  private toModel(item: any): Retail {
    const f = item?.fields ?? {};
    return {
        ...
        TipoDoc: f.TipoDoc,
        Nombre: f.Nombre,
        Empresaalaquepertenece: f.Empresaalaquepertenece,
        ...
        Cargo: f.Cargo,
        Salario: f.Salario,
        SalarioLetras: f.SalarioLetras,
        Auxiliodetransporte: f.Auxiliodetransporte,
        Auxiliotransporteletras: f.Auxiliotransporteletras,
        Depedencia: f.Depedencia,
        ...
        Promedio: f.Promedio,
        GrupoCVE: f.GrupoCVE,
        OrigenSeleccion: f.OrigenSeleccion,
  ...
  // ---------- CRUD ----------
  async create(record: Omit<Retail, 'ID'>) {
  ...
  async update(id: string, changed: Partial<Omit<Retail, 'ID'>>) {
        await this.ensureIds();
  ...
  async getAll(opts?: GetAllOpts): Promise<PageResult<Retail>> {
    await this.ensureIds();
  ...
  async getByNextLink(nextLink: string): Promise<PageResult<Retail>> {
    return this.fetchPage(nextLink, /*isAbsolute*/ true);
  }

  private async fetchPage(url: string, isAbsolute = false): Promise<PageResult<Retail>> {
